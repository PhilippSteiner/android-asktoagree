...
public enum NetworkURL {
    ...
    PRAYER_AGREE("prayer/", "agree/", "Agree to Prayer"),
    PRAYER_TOP_SHARED("prayer/", "topshared/", "Get top prayers by number shared"),
    PRAYER_TOP_AGREED("prayer/", "topagreed", "Get top prayers by number agreed"),
